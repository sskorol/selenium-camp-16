package com.blogspot.notes.automation.qa.core.model;

import com.blogspot.notes.automation.qa.core.db.entities.BaseEntity;
...
public class LoginWithValidCredentialsData extends BaseEntity {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof LoginWithValidCredentialsData)) return false;
	...
	public String toString() {
		return "LoginWithValidCredentialsData{" +
				"user=" + user +
				'}';
	}
}
